var PromiseEstimator = (function () {
  ...
  function d(a) {
    ...
    if (a && 'number' == typeof a.length)
      return {
        next: function () {
          return (
            a && d >= a.length && (a = void 0), { value: a && a[d++], done: !a }
          )
        },
      }
    throw new TypeError(
  ...
  function e(a, b) {
    ...
    var d,
      ...
      h = []
    try {
      for (; (void 0 === b || 0 < b--) && !(d = g.next()).done; )
        h.push(d.value)
    } catch (a) {
      f = { error: a }
    } finally {
  ...
  function g(a) {
    return this instanceof g ? ((this.v = a), this) : new g(a)
  }
  var h = function (a, c) {
      return (
        (h =
    ...
    m = Object.freeze({
      ...
      __generator: function (a, b) {
          ...
          for (; k; )
            try {
              ...
              switch ((((h = 0), i) && (c = [2 & c[0], i.value]), c[0])) {
                ...
                default:
                  if (
                    ((i = k.trys), !(i = 0 < i.length && i[i.length - 1])) &&
                    (6 === c[0] || 2 === c[0])
                  ) {
                    k = 0
                    continue
        ...
        return (
          (j = { next: c(0), throw: c(1), return: c(2) }),
      ...
      __await: g,
      __asyncGenerator: function (a, b, c) {
        function d(c) {
          m[c] &&
            (l[c] = function (d) {
              return new Promise(function (f, a) {
                1 < o.push([c, d, f, a]) || e(c, d)
              })
            })
        }
        function e(a, b) {
        ...
        function f(a) {
          a.value instanceof g
            ? Promise.resolve(a.value.v).then(h, j)
            : k(o[0][2], a)
        }
        function h(a) {
          e('next', a)
        ...
        function k(a, b) {
          ;(a(b), o.shift(), o.length) && e(o[0][0], o[0][1])
        }
      ...
      __asyncDelegator: function (a) {
        function b(b, e) {
          c[b] = a[b]
            ? function (c) {
                return (d = !d)
                  ? { value: g(a[b](c)), done: 'return' === b }
                  : e
                  ? e(c)
                  : c
              }
      ...
      __asyncValues: function (a) {
        function b(b) {
          e[b] =
            a[b] &&
            function (d) {
              return new Promise(function (e, f) {
                ;(d = a[b](d)), c(e, f, d.done, d.value)
              })
            }
        }
        function c(a, b, c, d) {
        ...
        return f
          ? f.call(a)
          : ((a = 'function' == typeof d ? d(a) : a[Symbol.iterator]()),
            (e = {}),
            b('next'),
            b('throw'),
            b('return'),
      ...
      __makeTemplateObject: function (a, b) {
        return (
      ...
      __importDefault: function (a) {
        return a && a.__esModule ? a : { default: a }
      },
      __classPrivateFieldGet: function (a, b) {
        if (!b.has(a))
          throw new TypeError('attempted to get private field on non-instance')
        return b.get(a)
      },
      __classPrivateFieldSet: function (a, b, c) {
        if (!b.has(a))
    ...
    n = b(function (a, b) {
      Object.defineProperty(b, '__esModule', { value: !0 }),
        (b.PromiseEstimator = void 0)
      b.PromiseEstimator = class {
        constructor() {
          this.estimates = {}
        }
        getEstimate(a, b) {
          return (
            this.estimates[a] || (this.estimates[a] = b),
            (b = this.estimates[a]),
            b
          )
        }
        ...
        work(a, b) {
          return new Promise((c) => {
            let { estimate: d, id: e } = b
            const { interval: f, intervalHandler: g } = b
            d = this.getEstimate(e, d)
            const h = Date.now()
            let i = setInterval(() => {
              if (0 < d) {
                const a = Date.now() - h,
                  b = d - a
                0 < b ? g(+(a / d).toFixed(2)) : (clearInterval(i), g(0.99))
              }
            }, f)
            a.then((a) => {
              clearInterval(i), g(1)
              const b = Date.now() - h
              this.updateEstimate(e, b), c(a)
            })
          })
        }
      }
  ...
  a(n)
  var o = n.PromiseEstimator,
    p = b(function (a, b) {
      Object.defineProperty(b, '__esModule', { value: !0 }),
        m.__exportStar(n, b),
        (b.default = n.PromiseEstimator)
    }),
    q = a(p)
  return q
})()
